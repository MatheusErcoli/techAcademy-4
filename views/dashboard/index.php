...
<body>
    ...
    <div class="sidebar">
        ...
        <a href=""><i class="fa fa-cart-shopping"></i> Produtos</a>
        <a href=""><i class="fa fa-list"></i> Categorias</a>
        <a href=""><i class="fa fa-users"></i> Clientes</a>
        <a href=""><i class="fa fa-user-tie"></i> Funcionários</a>
    ...
    <div class="content">
        ...
        <div class="container">
            <h4 class="text-white text-center mb-4">O que você gostaria de fazer?</h4>
            <div class="row g-4">
